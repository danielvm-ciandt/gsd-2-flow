...
exports.processGroupId = processGroupId;
...
function killTree(pid, signal) {
    return native_js_1.native.killTree(pid, signal);
}
/**
...
function listDescendants(pid) {
    return native_js_1.native.listDescendants(pid);
}
/**
...
function processGroupId(pid) {
    return native_js_1.native.processGroupId(pid);
}
/**
...
function killProcessGroup(pgid, signal) {
    return native_js_1.native.killProcessGroup(pgid, signal);
}
