...
export function getEnvApiKey(provider: any): string | undefined {
	...
	// ANTHROPIC_AUTH_TOKEN (Flow proxy JWT) > ANTHROPIC_OAUTH_TOKEN > ANTHROPIC_API_KEY
	if (provider === "anthropic") {
		return process.env.ANTHROPIC_AUTH_TOKEN || process.env.ANTHROPIC_OAUTH_TOKEN || process.env.ANTHROPIC_API_KEY;
	}
